    ...
    <div className="min-h-screen bg-[#04060C] text-slate-100 flex flex-col">
      ...
      <div className="w-full bg-[#070D1A] border-b border-slate-800 py-2.5 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 flex gap-8 items-center text-xs font-semibold whitespace-nowrap animate-pulse">
          <span className="text-slate-400 uppercase tracking-widest text-[10px]">NSE Active Tickers:</span>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {indices.map((idx, i) => (
            <div key={i} className="bg-slate-900 border border-slate-800 rounded-xl p-5 flex flex-col justify-between hover:border-slate-700 transition duration-300">
              <span className="text-xs font-bold text-slate-400 tracking-wider uppercase">{idx.name}</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <section className="lg:col-span-2 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                <div>
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm px-2.5 py-0.5 rounded-full bg-slate-800 border border-slate-700 text-slate-300">
                      {activeStock.name}
                    </span>
                  </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 text-center">
                <span className="text-xs text-slate-400 font-medium">PE Ratio</span>
                <p className="text-lg font-bold mt-1">26.8</p>
              </div>
              <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 text-center">
                <span className="text-xs text-slate-400 font-medium">Daily Volume</span>
                <p className="text-lg font-bold mt-1">6.8M</p>
              </div>
              <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 text-center">
                <span className="text-xs text-slate-400 font-medium">52W High</span>
            ...
            {activeStock.aiPrediction && (
              <div className="relative overflow-hidden bg-gradient-to-br from-blue-950/80 to-slate-900 border border-blue-900/50 rounded-2xl p-6 shadow-lg shadow-blue-950/20">
                ...
                <div className="space-y-4">
                  <div>
                    <span className="text-xs text-slate-400 font-medium block">24h Predicted Target</span>
                  ...
                  <div className="flex justify-between items-center bg-slate-950/60 rounded-xl p-3 border border-slate-800">
                    <div>
                      <span className="text-xs text-slate-500 font-semibold block">Trend direction</span>
        ...
        <section className="bg-slate-900 border border-slate-800 rounded-2xl p-6">
          <div className="flex items-center gap-2.5 mb-6">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Analyze real-time metrics and AI predictions of two prominent Indian stocks side-by-side.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center border-b border-slate-800/80 pb-6 mb-6">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-400 uppercase tracking-wider">Asset A Selector</label>
              <select
                value={tickerA}
            ...
            {/* Selector B */}
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-400 uppercase tracking-wider">Asset B Selector</label>
              <select
                value={tickerB}
              ...
              <table className="w-full text-left text-sm font-semibold">
                <thead>
                  <tr className="border-b border-slate-850 text-slate-400 text-xs uppercase tracking-wider">
                    ...
                    <th className="py-3 px-4 text-slate-500">Margin Variance</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-850/50">
                  <tr>
                    <td className="py-3.5 px-4 text-slate-400">Current Share Price</td>
                  ...
                  <tr>
                    <td className="py-3.5 px-4 text-slate-400">Daily Gain / Loss (%)</td>
                  ...
                  {dataA.aiPrediction && dataB.aiPrediction && (
                    <>
                      <tr>
                        <td className="py-3.5 px-4 text-slate-400">AI Target Forecast (24h)</td>
                      ...
                      <tr>
                        <td className="py-3.5 px-4 text-slate-400">AI Momentum Outlook</td>
