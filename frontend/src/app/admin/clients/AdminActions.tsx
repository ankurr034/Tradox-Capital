    ...
    <div className="relative inline-block text-left">
      <div className="flex items-center gap-2">
        <Link 
          ...
          className="p-2 inline-flex rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 transition text-slate-400 hover:text-blue-500"
          title="View Details"
        >
        ...
        <button 
          ...
          className="p-2 inline-flex rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 transition text-slate-400"
        >
          ...
          <div className="absolute right-0 mt-2 w-48 rounded-xl shadow-lg bg-white dark:bg-slate-800 ring-1 ring-black ring-opacity-5 z-50 border border-slate-200 dark:border-slate-700 overflow-hidden">
            <div className="py-1">
              <button
                ...
                className="w-full text-left px-4 py-2 text-sm font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-700 flex items-center gap-2"
              >
