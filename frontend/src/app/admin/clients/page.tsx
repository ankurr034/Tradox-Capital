        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm whitespace-nowrap">
            <thead className="bg-slate-50 dark:bg-slate-800/50">
              <tr>
                <th className="px-6 py-4 font-black text-xs uppercase tracking-wider text-slate-500">Client Name</th>
                <th className="px-6 py-4 font-black text-xs uppercase tracking-wider text-slate-500">Contact</th>
                <th className="px-6 py-4 font-black text-xs uppercase tracking-wider text-slate-500">Status</th>
              ...
              {clients.length === 0 ? (
                ...
                <tr key={client.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                  <td className="px-6 py-4">
                    ...
                    <div className="text-xs text-slate-500">ID: {client.id.substring(0,8).toUpperCase()}</div>
                  </td>
                  <td className="px-6 py-4">
                    <div className="text-slate-900 dark:text-slate-300">{client.user.email}</div>
